...
function updateText() {
    ...
    if (window.innerWidth <= 768) {
        pElement.innerHTML = 'Sou um entusiasta da programação com forte aptidão para resolver problemas complexos e implementar soluções inovadoras. Adquiri habilidades em programação e design de forma autodidata. Contribuo para a organização, fluidez de processos e otimização de atividades no desenvolvimento de software. Adaptável e comprometido com o aprendizado contínuo, busco oportunidades para aplicar minhas habilidades e me destacar como programador';
    } else {
